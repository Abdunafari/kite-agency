...
- **Professional UI**: Elegant "Coarse Sandy Ash" (#d7d3c8) aesthetic with high readability.
- **Audit Ledger**: Maintains a transparent log of all transactions and attestations with CSV/JSON export.
